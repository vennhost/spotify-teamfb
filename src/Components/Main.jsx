...
class Main extends Component {
  state = { album: null };
  //   playSong = album => {
  //     this.props.playSong_redux(album);
  //     // this.setState({ album });
  //   };
  render() {
    return (
            ...
            <div className={"col-10"}>
              <Router>
                <Route
                  path="/"
                  exact
                  render={props => <Body {...props} playSong={this.playSong} />}
                />
                <Route
                  path="/album/:albumId"
                  render={props => (
                    <AlbumsPage {...props} playSong={this.playSong} />
                  )}
                />
                <Route
                  path="/artist/:artistId"
                  render={props => (
                    <Artist {...props} playSong={this.playSong} />
                  )}
                />
              </Router>
            </div>
            ...
            <Row className="sticky-bottom">
              <Col className={"col-12"}>
                ...
                <AudioPlayer
                  ...
                  key={this.props.song.songDetail.id}
